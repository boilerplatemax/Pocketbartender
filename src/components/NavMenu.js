        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            <NavDropdown title="Popular" id="collasible-nav-dropdown">
              ...
              <NavDropdown.Item to={{pathname: `/filter/${query}`,hash: "#",}} onClick={()=>filterHandler('gin')}>Gin</NavDropdown.Item>
              <NavDropdown.Item to={{pathname: `/filter/${query}`,hash: "#"}} onClick={()=>filterHandler('vodka')}>Vodka</NavDropdown.Item>
              <NavDropdown.Item to={{pathname: `/filter/${query}`,hash: "#"}} onClick={()=>filterHandler('orange_juice')}>Orange Juice</NavDropdown.Item>
              <NavDropdown.Divider />
            </NavDropdown>
          </Nav>
          <Nav>
